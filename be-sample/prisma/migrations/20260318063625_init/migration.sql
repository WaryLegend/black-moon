...
CREATE TABLE `target_groups` (
    ...
    UNIQUE INDEX `target_groups_name_key`(`name`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `categories` (
    ...
    INDEX `categories_targetGroupId_idx`(`targetGroupId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `product_variants` (
    ...
    INDEX `product_variants_productId_price_idx`(`productId`, `price`),
...
-- AddForeignKey
ALTER TABLE `categories` ADD CONSTRAINT `categories_targetGroupId_fkey` FOREIGN KEY (`targetGroupId`) REFERENCES `target_groups`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
