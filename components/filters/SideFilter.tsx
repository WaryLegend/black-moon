...
// SideFilter renders a mobile-friendly drawer that batches multiple filters before applying them.
function SideFilter({ filters }: SideFilterProps) {
  ...
  const handleFilterChange = useCallback(
    (filterField: string, value: FilterState[string]) => {
